...
find ./lib -type f \( -name '*.cpp' -o -name '*.h' \) >> file_list.txt
find ./lib/animation -type f \( -name '*.cpp' -o -name '*.h' \) >> file_list.txt
find ./src/shaders -type f \( -name '*.cpp' -o -name '*.h' \) >> file_list.txt
